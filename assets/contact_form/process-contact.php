...
if (isset($_POST['action'])) { // Checking for submit form
	...
	$my_email = 'kaelymills@gmail.com'; // Change with your email address
	...
	if ($_POST['action'] == 'add') {
		...
		if ($email != '' && $message != '') {
			if (preg_match($pattern, $email)) {
				...
				echo 'success|<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ion-close"></i></button>Thanks for reaching out! I\'ll reach back soon.</div>';
			} else {
